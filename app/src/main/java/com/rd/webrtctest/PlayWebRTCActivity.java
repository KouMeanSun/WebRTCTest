...
public class PlayWebRTCActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_play_web_rtc);
        this.commonInit();
    }
    private void commonInit(){
        this.mContext = this;
        this.mServerUrlET = this.findViewById(R.id.et_webrtcserver_url);
        this.mServerUrlET.setText("webrtc://192.168.201.91/live/livestream");
        this.mSurfaceViewRender = this.findViewById(R.id.svr_video_frame);
    ...
    private void doPlay() {
        ...
        if (TextUtils.isEmpty(text)) {
            Toast.makeText(mContext, "拉流地址为空!", Toast.LENGTH_SHORT).show();
            return;
        }
        if (webRtcUtil1 != null) {
            webRtcUtil1.destroy();
        ...
        webRtcUtil1.create(mRootEglBase, this.mSurfaceViewRender, false, true, text, new WebRtcUtil.WebRtcCallBack() {
            @Override
